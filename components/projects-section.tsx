          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              {categories.map((category) => (
                ...
                >
                  {language === "ar" ? category.ar_name : category.name}
                </Button>
              ))}
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5  px-4">
              {filteredProjects.map((project, index) => (
                ...
                >
                  <CardContainer className="inter-var p-0 w-full">
                    <CardBody className="bg-white dark:bg-background relative group/card border border-gray-200 dark:border-border hover:shadow-xl hover:shadow-purple-500/[0.1] w-full h-auto rounded-xl p-6 backdrop-blur-sm transition-all duration-300 flex flex-col">
                      ...
                      <CardItem
                        as="p"
                        translateZ="60"
                        className="text-gray-600 dark:text-muted-foreground text-sm mb-4 truncate"
